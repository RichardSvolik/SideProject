...
const Feed = () => {
  ...
  const allCategoriesLabel = selectOptions.find(
    (option) => option.isAll === "true"
  ).label;

  const [itemCategory, setItemCategory] = useState(allCategoriesLabel);
  ...
  const filterByCategory = (item) => {
    if (itemCategory.includes(allCategoriesLabel)) {
      return true;
    } else {

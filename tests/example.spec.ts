...
test('add one item', async ({ page }) => {
  ...
  await page.locator('li').filter({ hasText: 'iPhonehttps://image.alza.cz/products/RI045b2/RI045b2.jpg?width=500&height=500200' }).getByLabel('delete').click();
  await expect(page.getByText('iPhone', { exact: true })).not.toBeVisible()

  await page.locator('li').filter({ hasText: 'iPhone 2https://image.alza.cz/products/RI045b2/RI045b2.jpg?width=500&height=5002' }).getByRole('checkbox').check();
  await page.locator('li').filter({ hasText: 'iPhone 3https://image.alza.cz/products/RI045b2/RI045b2.jpg?width=500&height=5002' }).getByRole('checkbox').check();
